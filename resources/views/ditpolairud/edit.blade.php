<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Edit Data DITPOLAIRUD: ' . $ditpolairud->nama_barang_bukti) }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-center">
                    <form method="post" action="{{route('ditpolairud.update', $ditpolairud)}}" enctype="multipart/form-data" class="w-1/2">
                        @csrf
                        @method('put')
                        <input type="hidden" name="unit" value="DITPOLAIRUD">
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            ...
                            <input id="nama_barang_bukti" type="hidden" value="{{old('nama_barang_bukti', $ditpolairud->nama_barang_bukti)}}" name="nama_barang_bukti">
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="identitas_barang_bukti" id="identitas_barang_bukti"
                                   value="{{old('identitas_barang_bukti', $ditpolairud->identitas_barang_bukti)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="jumlah" id="jumlah"
                                   value="{{old('jumlah', $ditpolairud->jumlah)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="no_laporan_polisi" id="no_laporan_polisi"
                                   value="{{old('no_laporan_polisi', $ditpolairud->no_laporan_polisi)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="no_sp_sita" id="no_sp_sita"
                                   value="{{old('no_sp_sita', $ditpolairud->no_sp_sita)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="penetapan_pengadilan" id="penetapan_pengadilan"
                                   value="{{old('penetapan_pengadilan', $ditpolairud->penetapan_pengadilan)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="tempat_penyimpanan" id="tempat_penyimpanan"
                                   value="{{old('tempat_penyimpanan', $ditpolairud->tempat_penyimpanan)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="penyidik" id="penyidik"
                                   value="{{old('penyidik', $ditpolairud->penyidik)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="kondisi" id="kondisi"
                                   value="{{old('kondisi', $ditpolairud->kondisi)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="nama_pemilik" id="nama_pemilik"
                                   value="{{old('nama_pemilik', $ditpolairud->nama_pemilik)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            ...
                            <input id="keterangan" type="hidden" value="{{old('keterangan', $ditpolairud->keterangan)}}" name="keterangan">
