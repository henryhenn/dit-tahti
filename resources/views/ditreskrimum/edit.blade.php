                    ...
                    <form method="post" action="{{route('ditreskrimum.update', $ditreskrimum)}}" enctype="multipart/form-data" class="w-1/2">
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            ...
                            <select id="underline_select" name="barang_temuan" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-300 @error('content') border-red-500 @enderror appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                ...
                                <option value="Daftar Barang Temuan" @selected($ditreskrimum->barang_temuan == 'Daftar Barang Temuan')>Daftar Barang Temuan</option>
                                <option value="Barang Temuan Sebagai Barang Bukti" @selected($ditreskrimum->barang_temuan == 'Barang Temuan Sebagai Barang Bukti')>Barang Temuan Sebagai Barang Bukti</option>
                            </select>
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="nama_barang_bukti" id="nama_barang_bukti"
                                   value="{{old('nama_barang_bukti', $ditreskrimum->nama_barang_bukti)}}"
