            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="float-right">
                        <a href="{{route('tugas-fungsi.create')}}"
                    ...
                    <div class="relative mt-14 overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                            @forelse($tugasfungsi as $key => $data)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4 flex flex-row">
                                        <a href="{{route('tugas-fungsi.edit', $data->id)}}"
                                        ...
                                        <a href="{{route('tugas-fungsi.show', $data->id)}}"
                                        ...
                                        <form action="{{route('tugas-fungsi.destroy', $data->id)}}" id="delete-form"
                                              method="post">
                                            @csrf
                                            @method('delete')
                                            <button type="submit"
                            ...
                            @empty
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <td colspan="5"
                                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <h3 class="text-xl font-bold text-center">Tidak ada data Tugas & Fungsi. Silakan tambahkan
                                            Tugas & Fungsi baru!</h3>
                                    </td>
                                </tr>
                            @endforelse
                            </tbody>
