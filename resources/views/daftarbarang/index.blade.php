...
@section('content')
                ...
                <div class="grid grid-cols-2 gap-4 p-2 lg:grid-cols-4 lg:gap-4 lg:p-4">
                    @forelse($barangs as $barang)
                        <div class="h-64 p-1 mb-2 border border-blue-400 rounded-md lg:mb-2">
                            ...
                            <div class="w-full">
                                <p class="text-xs text-gray-400 truncate">{{$barang->category->kategori}}</p>
                            </div>
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-2">
                                        <div class="grid grid-cols-2 gap-2 lg:flex">
                                            <img class="object-cover w-40 rounded-md h-44"
                                                 src="{{asset('storage/' . $barang->gambar1)}}"
                                                 alt="">
                                            <img class="object-cover w-40 rounded-md h-44"
                    ...
                    @empty
                        <h3 class="font-bold text-center text2xl">Tidak ada daftar barang terbaru</h3>
                    @endforelse
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto mt-4 mb-16">
        <div class="relative w-full">
            <div class="absolute inset-y-0 w-56 right-2 lg:w-80">
                {{$barangs->links()}}
            </div>
        </div>
    </div>
