            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="float-right">
                        <a href="{{route('gambar-beranda.create')}}"
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            @forelse($gambar as $key => $gambar)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4 flex flex-row">
                                        <a href="{{route('gambar-beranda.edit', $gambar->id)}}"
                                        ...
                                        <a href="{{route('gambar-beranda.show', $gambar->id)}}"
                                        ...
                                        <form action="{{route('gambar-beranda.destroy', $gambar->id)}}" id="delete-form"
                                              method="post">
                                            @csrf
                                            @method('delete')
                                            <button type="submit"
                            ...
                            @empty
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <td colspan="3"
                                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <h3 class="text-xl font-bold text-center">Tidak ada gambar beranda. Silakan tambahkan
                                            gambar beranda baru!</h3>
                                    </td>
                                </tr>
                            @endforelse
                            </tbody>
