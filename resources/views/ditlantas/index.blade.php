        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="relative mt-10 overflow-x-auto mb-16">
                        <h2 class="text-2xl font-bold mb-4">DITLANTAS Barang Bukti</h2>
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                            @forelse($barang_bukti as $key => $barang)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4 flex flex-row">
                                        <a href="{{route('ditlantas.edit', $barang->id)}}"
                                        ...
                                        <a href="{{route('ditlantas.show', $barang->id)}}"
                                        ...
                                        @role('Administrator')
                                        <form action="{{route('ditlantas.destroy', $barang->id)}}"
                                              id="delete-form"
                                              method="post">
                                            @csrf
                                            @method('delete')
                    ...
                    <div class="relative mt-12 overflow-x-auto">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                            @forelse($barang_temuan as $key => $barang)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="w-4 p-4 text-center">
                                        {{$key+1}}
                                    </td>
