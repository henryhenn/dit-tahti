        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-center">
                    <form method="post" action="{{route('daftar-barang.update', $daftar_barang->id)}}" enctype="multipart/form-data"
                          class="w-1/2">
                        @csrf
                        @method('put')
                        <div class="relative z-0 w-full mb-8">
                            ...
                            <select id="underline_select"
                                ...
                                <option value="BARANG TEMUAN SEBAGAI BARANG BUKTI" @selected($daftar_barang->daftar_barang_temuan == "BARANG TEMUAN SEBAGAI BARANG BUKTI")>BARANG TEMUAN SEBAGAI BARANG BUKTI</option>
                            </select>
                        ...
                        <div class="relative z-0 w-full mb-8">
                            ...
                            <select id="underline_select"
                                ...
                                <option value="DIT RESKRIM UM" @selected($daftar_barang->dit == 'DIT RESKRIM UM')>DIT RESKRIM UM</option>
                                <option value="DIT RESKRIM SUS" @selected($daftar_barang->dit == 'DIT RESKRIM SUS')>DIT RESKRIM SUS</option>
                                <option value="DIT NARKOBA" @selected($daftar_barang->dit == 'DIT NARKOBA')>DIT NARKOBA</option>
                                <option value="DIT LANTAS" @selected($daftar_barang->dit == 'DIT LANTAS')>DIT LANTAS</option>
                                <option value="DIT POLAIRUD" @selected($daftar_barang->dit == 'DIT POLAIRUD')>DIT POLAIRUD</option>
                            </select>
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="petugas_penyerah" id="petugas_penyerah"
                                   value="{{old('petugas_penyerah', $daftar_barang->petugas_penyerah)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="petugas_penerima" id="petugas_penerima"
                                   value="{{old('petugas_penerima', $daftar_barang->petugas_penerima)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            ...
                            <input id="keterangan" type="hidden" value="{{old('keterangan', $daftar_barang->keterangan)}}" name="keterangan">
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="kondisi_barang_bukti" id="kondisi_barang_bukti"
                                   value="{{old('kondisi_barang_bukti', $daftar_barang->kondisi_barang_bukti)}}"
