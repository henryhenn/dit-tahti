<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Edit Data DITRESNARKOBA: ' . $ditresnarkoba->nama_barang_bukti) }}
        </h2>
    </x-slot>
                    ...
                    <form method="post" action="{{route('ditresnarkoba.update', $ditresnarkoba)}}" enctype="multipart/form-data" class="w-1/2">
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            ...
                            <select id="underline_select" name="barang_temuan" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-300 @error('content') border-red-500 @enderror appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                ...
                                <option value="Daftar Barang Temuan" @selected($ditresnarkoba->barang_temuan == 'Daftar Barang Temuan')>Daftar Barang Temuan</option>
                                <option value="Barang Temuan Sebagai Barang Bukti" @selected($ditresnarkoba->barang_temuan == 'Barang Temuan Sebagai Barang Bukti')>Barang Temuan Sebagai Barang Bukti</option>
                            </select>
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="nama_barang_bukti" id="nama_barang_bukti"
                                   value="{{old('nama_barang_bukti', $ditresnarkoba->nama_barang_bukti)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="jumlah" id="jumlah"
                                   value="{{old('jumlah', $ditresnarkoba->jumlah)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="no_laporan_polisi" id="no_laporan_polisi"
                                   value="{{old('no_laporan_polisi', $ditresnarkoba->no_laporan_polisi)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="penetapan_kejaksaan" id="penetapan_kejaksaan"
                                   value="{{old('penetapan_kejaksaan', $ditresnarkoba->penetapan_kejaksaan)}}"
                                   class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 @error('penetapan_kejaksaan') border-red-500 @enderror appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                   placeholder=" "/>
                            <label for="title"
                                   class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="tempat_penyimpanan" id="tempat_penyimpanan"
                                   value="{{old('tempat_penyimpanan', $ditresnarkoba->tempat_penyimpanan)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="penyidik" id="penyidik"
                                   value="{{old('penyidik', $ditresnarkoba->penyidik)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="kondisi" id="kondisi"
                                   value="{{old('kondisi', $ditresnarkoba->kondisi)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="nama_pemilik" id="nama_pemilik"
                                   value="{{old('nama_pemilik', $ditresnarkoba->nama_pemilik)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            ...
                            <input id="keterangan" type="hidden" value="{{old('keterangan', $ditresnarkoba->keterangan)}}" name="keterangan">
