<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Edit Data DITRESKRIMSUS: ' . $ditreskrimsus->nama_barang_bukti) }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-center">
                    <form method="post" action="{{route('ditreskrimsus.update', $ditreskrimsus)}}" enctype="multipart/form-data" class="w-1/2">
                        @csrf
                        @method('put')
                        <div class="relative z-0 w-full mb-8 group">
                            ...
                            <select id="underline_select" name="barang_temuan" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-300 @error('content') border-red-500 @enderror appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                ...
                                <option value="Daftar Barang Temuan" @selected($ditreskrimsus->barang_temuan == 'Daftar Barang Temuan')>Daftar Barang Temuan</option>
                                <option value="Barang Temuan Sebagai Barang Bukti" @selected($ditreskrimsus->barang_temuan == 'Barang Temuan Sebagai Barang Bukti')>Barang Temuan Sebagai Barang Bukti</option>
                            </select>
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="nama_barang_bukti" id="nama_barang_bukti"
                                   value="{{old('nama_barang_bukti', $ditreskrimsus->nama_barang_bukti)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="jumlah" id="jumlah"
                                   value="{{old('jumlah', $ditreskrimsus->jumlah)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="no_laporan_polisi" id="no_laporan_polisi"
                                   value="{{old('no_laporan_polisi', $ditreskrimsus->no_laporan_polisi)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="penetapan_pengadilan" id="penetapan_pengadilan"
                                   value="{{old('penetapan_pengadilan', $ditreskrimsus->penetapan_pengadilan)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="tempat_penyimpanan" id="tempat_penyimpanan"
                                   value="{{old('tempat_penyimpanan', $ditreskrimsus->tempat_penyimpanan)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="penyidik" id="penyidik"
                                   value="{{old('penyidik', $ditreskrimsus->penyidik)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="kondisi" id="kondisi"
                                   value="{{old('kondisi', $ditreskrimsus->kondisi)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="nama_pemilik" id="nama_pemilik"
                                   value="{{old('nama_pemilik', $ditreskrimsus->nama_pemilik)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            ...
                            <input id="keterangan" type="hidden" value="{{old('keterangan', $ditreskrimsus->keterangan)}}" name="keterangan">
