                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-center">
                    <form method="post" action="{{route('ditreskrimsus.update', $ditreskrimsus)}}" enctype="multipart/form-data" class="w-1/2">
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            ...
                            <select id="underline_select" name="category_id" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-300 @error('content') border-red-500 @enderror appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                @foreach($kategori as $kategori)
                                    <option value="{{$kategori->id}}" @selected($kategori->id == $ditreskrimsus->category_id)>{{$kategori->kategori}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            ...
                            <input id="nama_barang_bukti" type="hidden" value="{{old('nama_barang_bukti', $ditreskrimsus->nama_barang_bukti)}}" name="nama_barang_bukti">
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="identitas_barang_bukti" id="identitas_barang_bukti"
                                   value="{{old('identitas_barang_bukti', $ditreskrimsus->identitas_barang_bukti)}}"
                        ...
                        <div class="relative z-0 w-full mb-8 group">
                            <input type="text" name="no_sp_sita" id="no_sp_sita"
                                   value="{{old('no_sp_sita', $ditreskrimsus->no_sp_sita)}}"
