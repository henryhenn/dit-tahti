            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between">
                        <x-export-buttons print-route="ditreskrimsus.printbukti" export-route="ditreskrimsus.export" />
                    ...
                    <x-export-buttons print-route="ditreskrimsus.printtemuan" export-route="ditreskrimsus.export" />
